...
import numpy as np
from plot_p300_data import load_erp_data, plot_confidence_intervals, bootstrap_erps, bootstrapped_test_statistic, fdr_correction
...
# find test statistic
erp_difference = bootstrapped_test_statistic(sampled_target_erp, sampled_nontarget_erp)

# fdr_correction(erp_times, target_erp, nontarget_erp, p_values, fdr_threshold = 0.05)
